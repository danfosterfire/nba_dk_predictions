...
This was the whole of `app.py` until 2026-08-10, when the dashboard became a multipage
app; `app.py` is now the `st.navigation` entrypoint and this is the page it navigates to.
The view is unchanged by that move except that the appearance switch moved up into the
shell — see `dashboard/shell.py` for why it had to. Reached through `make dashboard`.
"""

import pandas as pd
import streamlit as st

from dashboard import pca, shell
